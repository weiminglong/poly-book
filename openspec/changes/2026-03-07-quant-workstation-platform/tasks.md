...
- [x] Add WebSocket order book streaming for workstation clients
...
- [x] Implement Integrity and Execution Timeline routes (Latency and Query Workbench deferred)
...
- [x] Replace HTTP polling with WebSocket order book streaming once the backend route exists
- [x] Add virtualization and render throttling for deeper books and future streams
- [x] Add frontend performance budgets and production profiling hooks

## Phase 5: CI, Docs, And Packaging

- [x] Add frontend lint, typecheck, test, and build jobs to CI
...
- [x] Add local development instructions for running the API and web app together
- [x] Define later deployment packaging for the Rust API and static web assets
